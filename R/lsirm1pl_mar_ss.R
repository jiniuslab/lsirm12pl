...
lsirm1pl_mar_ss = function(data, ndim = 2, niter = 15000, nburn = 2500, nthin = 5, nprint = 500,
                           ...
                           pr_a_theta = 0.001, pr_b_theta = 0.001, pr_xi_a  = 1, pr_xi_b = 1,  missing.val = 99, verbose=FALSE, fix_theta=FALSE){
  if(niter < nburn){
  ...
  output <- lsirm1pl_mar_ss_cpp(data=as.matrix(data), ndim=ndim, niter=niter, nburn=nburn, nthin=nthin, nprint=nprint,
                                jump_beta=jump_theta, jump_theta=jump_theta, jump_gamma=jump_gamma, jump_z=jump_w,
                                ...
                                pr_a_theta=pr_a_theta, pr_b_theta=pr_b_theta, pr_beta_a = pr_xi_a, pr_beta_b = pr_xi_b, missing.val=missing.val, verbose=verbose, fix_theta=fix_theta)
