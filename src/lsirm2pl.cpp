...
Rcpp::List lsirm2pl_cpp (arma::mat data, const int ndim, const int niter, const int nburn, const int nthin, const int nprint,
                       ...
                       const double pr_mean_alpha, const double pr_sd_alpha, const double pr_a_theta, const double pr_b_theta, const bool verbose, const bool fix_theta){
...
Rcpp::List lsirm2pl_normal_fixed_gamma_cpp(arma::mat data,
                                           ...
                                           const double pr_a_eps, const double pr_b_eps, const double pr_mean_alpha, const double pr_sd_alpha, const bool verbose, const bool fix_theta){
...
Rcpp::List lsirm2pl_normal_fixed_gamma_mar_cpp(arma::mat data,
                                               ...
                                               const double pr_a_eps, const double pr_b_eps, const double pr_mean_alpha, const double pr_sd_alpha, const double missing, const bool verbose, const bool fix_theta){
...
Rcpp::List lsirm2pl_fixed_gamma_mar_cpp(arma::mat data, const int ndim, const int niter, const int nburn, const int nthin, const int nprint,
                                        const double jump_beta, const double jump_theta, const double jump_alpha, const double jump_z, const double jump_w,
                                        const double pr_mean_beta, const double pr_sd_beta, const double pr_mean_theta, double pr_sd_theta,
                                        const double pr_mean_alpha, const double pr_sd_alpha, const double pr_a_theta, const double pr_b_theta, const double missing, const bool verbose, const bool fix_theta){
...
Rcpp::List lsirm2pl_mar_ss_cpp(arma::mat data, const int ndim, const int niter, const int nburn, const int nthin, const int nprint,
                               ...
                               const double pr_mean_alpha, const double pr_sd_alpha, const double pr_a_theta, const double pr_b_theta, const double pr_beta_a, const double pr_beta_b, const double missing, const bool verbose, const bool fix_theta){
...
Rcpp::List lsirm2pl_normal_cpp(arma::mat data,
                               ...
                               const double jump_beta, const double jump_theta, const double jump_alpha, const double jump_gamma, const double jump_z, const double jump_w,
                               const double pr_mean_beta, const double pr_sd_beta, const double pr_a_theta, const double pr_b_theta, const double pr_mean_theta, double pr_sd_theta,
                               const double pr_a_eps, const double pr_b_eps, const double pr_mean_gamma, const double pr_sd_gamma, const double pr_mean_alpha, const double pr_sd_alpha, const bool verbose, const bool fix_theta){
...
Rcpp::List lsirm2pl_normal_mcar_cpp(arma::mat data,
                                    ...
                                    const double pr_mean_gamma, const double pr_sd_gamma,
                                    const double pr_mean_alpha, const double pr_sd_alpha, const double missing, const bool verbose, const bool fix_theta){
...
Rcpp::List lsirm2pl_normal_mcar_ss_cpp(arma::mat data, const int ndim, const int niter, const int nburn, const int nthin, const int nprint,
                                       ...
                                       const double pr_beta_a, const double pr_beta_b, const double missing, const bool verbose, const bool fix_theta){
...
Rcpp::List lsirm2pl_normal_ss_cpp(arma::mat data, const int ndim, const int niter, const int nburn, const int nthin, const int nprint,
                                  ...
                                  const double pr_mean_alpha, const double pr_sd_alpha,
                                  const double pr_a_eps, const double pr_b_eps, const double pr_a_theta, const double pr_b_theta,
                                  const double pr_beta_a, const double pr_beta_b, const bool verbose, const bool fix_theta){
...
Rcpp::List lsirm2pl_ss_cpp(arma::mat data, const int ndim, const int niter, const int nburn, const int nthin, const int nprint,
                           ...
                           const double pr_mean_beta, const double pr_sd_beta, const double pr_mean_theta, double pr_sd_theta,
                           const double pr_spike_mean, const double pr_spike_sd, const double pr_slab_mean, const double pr_slab_sd,
                           const double pr_mean_alpha, const double pr_sd_alpha, const double pr_a_theta, const double pr_b_theta, const double pr_beta_a, const double pr_beta_b, const bool verbose, const bool fix_theta){
...
Rcpp::List lsirm2pl_normal_mar_cpp(arma::mat data,
                                   ...
                                   const double jump_beta, const double jump_theta, const double jump_alpha, const double jump_gamma, const double jump_z, const double jump_w,
                                   const double pr_mean_beta, const double pr_sd_beta, const double pr_a_theta, const double pr_b_theta, const double pr_mean_theta, double pr_sd_theta,
                                   const double pr_a_eps, const double pr_b_eps, const double pr_mean_gamma, const double pr_sd_gamma, const double pr_mean_alpha, const double pr_sd_alpha, const double missing, const bool verbose, const bool fix_theta){
